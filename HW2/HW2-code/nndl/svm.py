...
class SVM(object):
  ...
  def fast_loss_and_grad(self, X, y):
    ...
    num_train = X.shape[0]
    correct_score = np.ones(score.shape)*score[y, np.arange(0, score.shape[1])]
    mark = score - correct_score + np.ones(score.shape)
    mark[mark<0] = 0
    mark[y, np.arange(0, score.shape[1])]=0
    loss = np.sum(mark)/num_train
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    # ================================================================ #
    mark[mark>0]=1
    mark[y, np.arange(0, score.shape[1])] -= np.sum(mark, axis=0)
    grad = mark.dot(X)/num_train
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
